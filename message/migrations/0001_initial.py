...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'message_message', (
            ...
            ('senderID', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sender', to=orm['auth.User'])),
            ('receiverID', self.gf('django.db.models.fields.related.ForeignKey')(related_name='receiver', to=orm['auth.User'])),
            ('fromPatient', self.gf('django.db.models.fields.BooleanField')()),
            ('timeSent', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('timeOpened', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
