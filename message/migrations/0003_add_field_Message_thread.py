...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Message.thread'
        db.add_column(u'message_message', 'thread',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['message.Thread']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Message.thread'
        db.delete_column(u'message_message', 'thread_id')
