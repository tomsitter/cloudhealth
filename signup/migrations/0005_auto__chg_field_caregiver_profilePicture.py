...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Caregiver.profilePicture'
        db.alter_column(u'signup_caregiver', 'profilePicture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Caregiver.profilePicture'
        db.alter_column(u'signup_caregiver', 'profilePicture', self.gf('django.db.models.fields.DateField')(default='/home/action/workspace/cloudhealth/static/images/cloud_dialog.png'))
