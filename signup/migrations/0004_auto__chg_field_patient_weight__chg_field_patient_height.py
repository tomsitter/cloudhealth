...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'signup_patient', 'weight', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

        # Changing field 'Patient.height'
        db.alter_column(u'signup_patient', 'height', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Patient.weight'
        db.alter_column(u'signup_patient', 'weight', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=3))

        # Changing field 'Patient.height'
        db.alter_column(u'signup_patient', 'height', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=3))
